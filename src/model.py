...
from tensorflow.keras.layers import (
    Activation, Conv2D, BatchNormalization, Conv2DTranspose,
    Concatenate, MaxPooling2D, Input, Conv1D, Reshape
)
...
def get_model(img_size, num_classes=1):
    ...
    # Bottleneck
    conv9 = Conv2D(1024, 3, padding="same")(pool4)
    conv9 = BatchNormalization()(conv9)
    conv9 = Activation("relu")(conv9)

    conv10 = Conv2D(1024, 3, padding="same")(conv9)
    ...
    upconv1 = Conv2D(512, 3, padding="same")(up1)
    upconv1 = BatchNormalization()(upconv1)
    upconv1 = Activation("relu")(upconv1)

    upconv2 = Conv2D(512, 3, padding="same")(upconv1)
    ...
    upconv3 = Conv2D(256, 3, padding="same")(up2)
    upconv3 = BatchNormalization()(upconv3)
    upconv3 = Activation("relu")(upconv3)

    upconv4 = Conv2D(256, 3, padding="same")(upconv3)
    ...
    upconv5 = Conv2D(128, 3, padding="same")(up3)
    upconv5 = BatchNormalization()(upconv5)
    upconv5 = Activation("relu")(upconv5)

    upconv6 = Conv2D(128, 3, padding="same")(upconv5)
    ...
    upconv7 = Conv2D(64, 3, padding="same")(up4)
    upconv7 = BatchNormalization()(upconv7)
    upconv7 = Activation("relu")(upconv7)

    upconv8 = Conv2D(64, 3, padding="same")(upconv7)
    upconv8 = BatchNormalization()(upconv8)
    upconv8 = Activation("relu")(upconv8)

    # 🔥 FIXED OUTPUT (Conv1D compatible)
    x = Reshape((512*128, 64))(upconv8)
    x = Conv1D(num_classes, 1, activation="linear")(x)
    output = Reshape((512,128,1))(x)
